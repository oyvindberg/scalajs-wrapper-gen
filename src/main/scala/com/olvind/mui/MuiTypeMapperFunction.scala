...
object MuiTypeMapperFunction {
  sealed trait MappedF
  case class F0(r: String) extends MappedF
...
//      case ("Drawer",           "onChange")                  => "(ReactEventH, Int, js.Any) => Callback"
//      case ("Drawer",           "onNavOpen")                 => "Callback"
//      case ("Drawer",           "onNavClose")                => "Callback"
//      case ("Drawer",           "onChangeRequest")           => "(Boolean, String) => Callback"
      ...
      case ("Menu",             "onItemTouchTap")            => "(ReactUIEventH, JsComponentM[MuiMenuItemProps[T], _, TopNode]) => Callback"
      ...
      case (_, "onMouseOut") => "ReactMouseEventH => Callback"
