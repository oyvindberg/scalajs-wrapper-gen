...
object ButtonSharedComponent extends SharedComponent {
  ...
  val inheritProps = List[OutField](
    OptField("centerRipple",           OutParam.mapType(name, "centerRipple"        )("bool"                         ), None),
    OptField("containerElement",       OutParam.mapType(name, "containerElement"    )("oneOfType([string, element])" ), None),
    OptField("disabled",               OutParam.mapType(name, "disabled"            )("bool"                         ), None),
    OptField("disableFocusRipple",     OutParam.mapType(name, "disableFocusRipple"  )("bool"                         ), None),
    OptField("disableKeyboardFocus",   OutParam.mapType(name, "disableKeyboardFocus")("bool"                         ), None),
    OptField("disableTouchRipple",     OutParam.mapType(name, "disableTouchRipple"  )("bool"                         ), None),
    OptField("keyboardFocused",        OutParam.mapType(name, "keyboardFocused"     )("bool"                         ), None),
    OptField("linkButton",             OutParam.mapType(name, "linkButton"          )("bool"                         ), None),
  ...
  val inheritEvents = List[OutField](
    OptField("onClick",                OutParamClass("ReactEventH => Callback"), None),
    ...
    OptField("onTouchTap",             OutParamClass("ReactTouchEventH => Callback"), Some(JsonField("onTouchTap", Some("function(event)"), "optional", "Called when a touch tap event occures on the button.")))
  )
}
...
//    ReqField("switched",           OutParam.mapType(name, "switched"          )("bool"),                     None),
    ...
    OptField("required",           OutParam.mapType(name, "required"          )("bool"),              None),
    OptField("disabled",           OutParam.mapType(name, "disabled"          )("bool"),              None),
    OptField("defaultSwitched",    OutParam.mapType(name, "defaultSwitched"   )("bool"),              None),
...
object Component {
  ...
  object MuiBadge extends Component {
    override val children = true
    val name = "MuiBadge"
  ...
  trait MuiGrid extends Component {
    override val children = true
    val json = """[{"name":"GridList Props","infoArray":[{"name":"cols","type":"number","header":"optional","desc":"Number of columns. Defaults to 2."},{"name":"padding","type":"number","header":"optional","desc":"Number of px for the padding/spacing between items. Defaults to 4."},{"name":"cellHeight","type":"number","header":"optional","desc":"Number of px for one cell height. Defaults to 180."},{"name":"style","type":"object","header":"optional","desc":"Override the inline-styles of the grid list's root element."}]},{"name":"GridTile Props","infoArray":[{"name":"title","type":"node","header":"optional","desc":"Title to be displayed on tile."},{"name":"subtitle","type":"node","header":"optional","desc":"String or element serving as subtitle (support text)."},{"name":"titlePosition","type":"oneOf [\"top\", \"bottom\"]","header":"optional","desc":"Position of the title bar (container of title, subtitle and action icon). Defaults to \"bottom\"."},{"name":"titleBackground","type":"string","header":"optional","desc":"Style used for title bar background. Defaults to \"rgba(0, 0, 0, 0.4)\". Useful for setting custom gradients for example"},{"name":"actionIcon","type":"element","header":"optional","desc":"An IconButton element to be used as secondary action target (primary action target is the tile itself)."},{"name":"actionPosition","type":"oneOf [\"left\", \"right\"]","header":"optional","desc":"Position of secondary action IconButton. Defaults to \"right\"."},{"name":"cols","type":"number","header":"optional","desc":"Width of the tile in number of grid cells. Defaults to 1."},{"name":"rows","type":"number","header":"optional","desc":"Height of the tile in number of grid cells. Defaults to 1."},{"name":"style","type":"object","header":"optional","desc":"Override the inline-styles of the grid tile's root element."},{"name":"rootClass","type":"string|ReactComponent","header":"optional","desc":"Either a string used as tag name for the tile root element, or a ReactComponent. Defaults to \"div\".This is useful when you have, for example, a custom implementation of a navigation link (that knowsabout your routes) and you want to use it as primary tile action. In case you pass a ReactComponent, please make sure that it passes all props, accepts styles overrides and render it's children."},{"name":"children","type":"node","header":"required","desc":"Theoretically you can pass any node as children, but the main use case is to pass an img, in whichcase GridTile takes care of making the image \"cover\" available space (similar to background-size: cover or to object-fit:cover)"}]}]"""
  }
  ...
  object MuiPopover extends Component {
    override val children = true
    val name = "MuiPopover"
    ...
    override val postlude: Option[String] = {
      val m = """case class Origin(vertical: MuiPopoverVertical, horizontal: MuiPopoverHorizontal){
