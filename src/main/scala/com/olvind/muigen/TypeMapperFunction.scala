...
object TypeMapperFunction {
  def apply(compName: CompName, name: PropName): String =
    (compName.value, name.value) match {
      ...
      case ("AutoComplete", "onNewRequest") => "(js.Any, Int, js.Array[js.Any] | js.Any) => Callback"
      case ("AutoComplete", "onUpdateInput") => "(String, js.Array[js.Any] | js.Any) => Callback"
      case ("AutoComplete", "filter") => "(String, String, js.UndefOr[js.Any]) => Callback"
